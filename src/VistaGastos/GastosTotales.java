 ...
 * @author FAMILIA
 */
public class GastosTotales extends javax.swing.JFrame {
...
DefaultTableModel modelo;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(74, 66, 118, 50);

        jLabel1.setFont(new java.awt.Font("Kristen ITC", 1, 18)); // NOI18N
        jLabel1.setText("GASTOS  TOTALES ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(35, 11, 208, 25);
        ...
        BotonMostrar.setBounds(85, 134, 99, 33);
        ...
        jButton1.setBounds(113, 185, 79, 33);
    ...
    private void BotonMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonMostrarActionPerformed
      ArrayList<String[]> datos = conexion.consulta("SELECT SUM(Valor) FROM Gastos ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GastosTotales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
